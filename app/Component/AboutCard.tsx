  ...
  "
      ...
      >
        <p className="">
          ...
          supérieure de renom. Mon expertise exceptionnelle s&lsquo;étend du
          JavaScript au Java et au-delà, résultat d&lsquo;une expérience
          professionnelle variée et enrichissante.
        </p>
        <p className="mt-3">
          Mon parcours m&lsquo;a confronté à une diversité de défis, des projets
