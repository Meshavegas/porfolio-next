  ...
  return (
    <div className="h-1/2 my-20 md:mx-20 mx-4">
      ...
      <p className="text-2xl text-black text-justify">
        ...
        développement backend, l'intégration d'API, la sécurité des données, la
        maintenance et l'optimisation des performances. Faites confiance à notre
        équipe expérimentée pour concrétiser vos idées numériques et offrir des
        solutions sur mesure à vos besoins.
      </p>
